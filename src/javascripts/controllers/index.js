...
import PscSearchController from './psc_search_controller.js'
...
application.register('max-height-accordion', MaxHeightAccordionController)
...
application.register('psc-search', PscSearchController)
